...
async function getFolder(folderId) {
    const res = await api.get("/folders/".concat(folderId));
    return res.data;
}
async function getStyles() {
    ...
    const res = await api.get("/folders");
    var _res_data_items;
    const folders = (_res_data_items = res.data.items) !== null && _res_data_items !== void 0 ? _res_data_items : [];
    let items = folders.map((f)=>{
        var _f_cover_image, _f_cover_image1, _f_preview_images;
        return {
            id: f.folder_id,
            title: f.title,
            category: f.title.split(" ")[0].toLowerCase(),
            thumbnail: (_f_cover_image = f.cover_image) !== null && _f_cover_image !== void 0 ? _f_cover_image : undefined,
            image_url: (_f_cover_image1 = f.cover_image) !== null && _f_cover_image1 !== void 0 ? _f_cover_image1 : undefined,
            card_count: f.prompt_count,
            // ← each card carries the REAL prompt_id from the backend
            cards: ((_f_preview_images = f.preview_images) !== null && _f_preview_images !== void 0 ? _f_preview_images : []).map((pi)=>({
...
async function getGenerationStatus(taskId) {
    const res = await api.get("/generation/".concat(taskId));
    return res.data;
}
...
function resolveImageUrl(cloudinaryUrl, originalUrl, fallbackPath) {
    ...
    if (originalUrl) {
        return originalUrl.startsWith("http") ? originalUrl : "".concat(API_BASE_URL).concat(originalUrl);
    }
    if (fallbackPath) {
        return fallbackPath.startsWith("http") ? fallbackPath : "".concat(API_BASE_URL).concat(fallbackPath);
    }
    return "";
}
...
function CategoryFilter(param) {
    ...
    async function loadCategories() {
        try {
            setLoading(true);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategories"])();
            setCategories([
                "All",
                ...response.items
            ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: categories.map((category)=>{
            ...
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                className: "\n              whitespace-nowrap\n              rounded-full\n              border\n              px-5\n              py-2\n              text-xs\n              font-bold\n              tracking-wide\n              transition-all\n              duration-300\n              cursor-pointer\n\n              ".concat(active ? "border-indigo-500/30 bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg shadow-indigo-600/20" : "border-white/5 bg-white/5 text-gray-400 hover:border-white/10 hover:bg-white/10 hover:text-white", "\n            "),
                children: category
            }, category, false, {
                fileName: "[project]/components/CategoryFilter.tsx",
                lineNumber: 67,
...
_s(CategoryFilter, "Ku/3fYTZ4p+HhLbl/Ex0fsiHh1U=");
_c = CategoryFilter;
var _c;
...
"[project]/components/StyleCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StyleCard(param) {
    let { title, category, image, selected, onClick, cardCount } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].button, {
        ...
        onClick: onClick,
        className: "\n        group\n        relative\n        overflow-hidden\n        rounded-2xl\n        border\n        bg-white/5\n        shadow-lg\n        transition-all\n        duration-300\n        cursor-pointer\n        ".concat(selected ? "border-indigo-500 ring-2 ring-indigo-500/30" : "border-white/5 hover:border-white/20 hover:shadow-neon", "\n      "),
        children: [
            ...
            cardCount !== undefined && cardCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$StyleCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/StyleCard.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Gallery(param) {
    let { search, category, selectedStyle, onSelect } = param;
    _s();
    ...
    async function loadStyles() {
        try {
            setLoading(true);
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStyles"])({
                page: 1,
                limit: 100,
    ...
    if (activeFolder) {
        var _activeFolder_cards, _activeFolder_cards1;
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    "Select one of the ",
                                    (_activeFolder_cards = activeFolder.cards) === null || _activeFolder_cards === void 0 ? void 0 : _activeFolder_cards.length,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "grid grid-cols-2 gap-5 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5",
                    children: (_activeFolder_cards1 = activeFolder.cards) === null || _activeFolder_cards1 === void 0 ? void 0 : _activeFolder_cards1.map((card, index)=>{
                        const cardId = card.prompt_id; // <-- use backend-generated ID
                        const isSelected = (selectedStyle === null || selectedStyle === void 0 ? void 0 : selectedStyle.id) === cardId;
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$StyleCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            id: cardId,
                            title: "Option ".concat(index + 1),
                            category: activeFolder.category,
                            image: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(card.image_url),
                            selected: isSelected,
                            onClick: ()=>onSelect({
                                    id: cardId,
                                    title: "".concat(activeFolder.title, " (Option ").concat(index + 1, ")"),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: styles.map((style)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$StyleCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                image: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(style.thumbnail || style.image_url || ""),
                cardCount: style.card_count,
                selected: (selectedStyle === null || selectedStyle === void 0 ? void 0 : selectedStyle.id) === style.id || ((selectedStyle === null || selectedStyle === void 0 ? void 0 : selectedStyle.id) ? selectedStyle.id.startsWith(style.id + "::p") : false),
                onClick: ()=>{
...
_s(Gallery, "ig0DRmvaR6MK9P5e88+pHgan7DI=");
_c = Gallery;
var _c;
...
"[project]/components/ResultModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function ResultModal(param) {
    let { image, onClose } = param;
    if (!image) {
        return null;
    }
    const imageUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(image);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function SearchBar(param) {
    let { value, onChange, placeholder = "Search styles..." } = param;
    _s();
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            inputValue.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                type: "button",
                onClick: clearSearch,
...
_s(SearchBar, "GCrVSfzLGUaZH6um3qlkJQJ/LQQ=");
_c = SearchBar;
var _c;
...
function UploadBox(param) {
    ...
    const { getRootProps, getInputProps, isDragActive } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$dropzone$2f$dist$2f$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useDropzone"])({
        ...
        multiple: false,
        onDrop: {
            "UploadBox.useDropzone": (acceptedFiles)=>{
                var _acceptedFiles_;
                onChange((_acceptedFiles_ = acceptedFiles[0]) !== null && _acceptedFiles_ !== void 0 ? _acceptedFiles_ : null);
            }
        }["UploadBox.useDropzone"]
    });
    if (file) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "space-y-4",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...getRootProps(),
        className: "\n        flex\n        min-h-[256px]\n        items-center\n        justify-center\n        p-8\n        text-center\n        rounded-2xl\n        border-2\n        border-dashed\n        transition-all\n        duration-300\n        cursor-pointer\n        ".concat(isDragActive ? "border-indigo-500 bg-indigo-500/5 shadow-inner" : "border-white/10 bg-white/5 hover:border-indigo-500/40 hover:bg-white/10", "\n      "),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                ...getInputProps()
            }, void 0, false, {
...
_s(UploadBox, "MC8iXHW7EwXP9Tjt9KaPpisTgkA=", false, function() {
    return [
...
"[project]/components/RecentGallery.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function RecentGallery(param) {
    let { refreshTrigger } = param;
    _s();
    const [items, setItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [styleMap, setStyleMap] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RecentGallery.useEffect": ()=>{
            const initialize = {
                "RecentGallery.useEffect.initialize": async ()=>{
                    try {
                        setError("");
                        // Load styles map dynamically
                        const stylesResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStyles"])({
                            limit: 100
                        });
                        const mapping = {};
                        stylesResponse.items.forEach({
                            "RecentGallery.useEffect.initialize": (style)=>{
                                mapping[style.id] = style.title;
                            }
                        }["RecentGallery.useEffect.initialize"]);
                        setStyleMap(mapping);
                        // Load recent generated images
                        const galleryResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGallery"])(1);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$refresh$2d$cw$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__RefreshCw$3e$__["RefreshCw"], {
                                className: "h-3.5 w-3.5 ".concat(loading ? "animate-spin" : "")
                            }, void 0, false, {
                                fileName: "[project]/components/RecentGallery.tsx",
                                lineNumber: 92,
                                columnNumber: 11
            ...
            loading && items.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                    children: items.map((item, index)=>{
                        ...
                        const generatedSrc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(item.image_url);
                        const originalSrc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(item.original_url || "");
                        var _item_task_id;
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            initial: {
                                opacity: 0,
                        ...
                        }, (_item_task_id = item.task_id) !== null && _item_task_id !== void 0 ? _item_task_id : index, true, {
                            fileName: "[project]/components/RecentGallery.tsx",
                            lineNumber: 134,
                            columnNumber: 17
                        }, this);
...
_s(RecentGallery, "muqOFPOjmbxxmM1aLHRlOm8+Xrg=");
_c = RecentGallery;
var _c;
__turbopack_context__.k.register(_c, "RecentGallery");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ResultModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ResultModal.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$RecentGallery$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/RecentGallery.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function HomePage() {
    ...
    // Selected Style
    // ---------------------------------------
    const [selectedStyle, setSelectedStyle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // ---------------------------------------
    // Uploaded Image
    // ---------------------------------------
    ...
    async function handleGenerate() {
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateImage"])(selectedStyle.id, selectedFile);
            ...
            while(attempts < MAX_ATTEMPTS){
                ...
                const status = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGenerationStatus"])(response.task_id);
                ...
                setGenerationProgress((prev)=>{
                    ...
                    return Math.max(prev, (_status_progress = status.progress) !== null && _status_progress !== void 0 ? _status_progress : 0);
                });
                ...
                if (status.status === "failed") {
                    var _status_error;
                    throw new Error((_status_error = status.error) !== null && _status_error !== void 0 ? _status_error : "Generation failed.");
                }
            }
    ...
    var _selectedStyle_title, _selectedFile_name;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        selectedStyle && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-semibold ".concat(selectedStyle ? "text-indigo-400" : "text-gray-600"),
                                                        children: (_selectedStyle_title = selectedStyle === null || selectedStyle === void 0 ? void 0 : selectedStyle.title) !== null && _selectedStyle_title !== void 0 ? _selectedStyle_title : "None selected"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/page.tsx",
                                                        lineNumber: 261,
                                                        columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-semibold max-w-[200px] truncate ".concat(selectedFile ? "text-green-400" : "text-gray-600"),
                                                        children: (_selectedFile_name = selectedFile === null || selectedFile === void 0 ? void 0 : selectedFile.name) !== null && _selectedFile_name !== void 0 ? _selectedFile_name : "None uploaded"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/page.tsx",
                                                        lineNumber: 268,
                                                        columnNumber: 17
                                    ...
                                    (loading || generationStatus) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$RecentGallery$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ResultModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(HomePage, "SVHFcW3JmOmuoGQG+t6Wot6zfto=");
_c = HomePage;
var _c;
...
//# sourceMappingURL=_756310ee._.js.map